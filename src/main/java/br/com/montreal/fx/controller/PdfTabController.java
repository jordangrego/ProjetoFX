...
public class PdfTabController extends AbstractFxTabController {
	...
	@FXML
	private ComboBox<Integer> cbPaginas;
	...
	public void apresentaPdf(ReportDto dto) {
		try {
			...
			// centraliza o stackpane e a imagem do relatorio.
			this.stckPane.minWidthProperty().bind(Bindings.createDoubleBinding(() -> this.spnlReport.getViewportBounds().getWidth(), this.spnlReport.viewportBoundsProperty()));
		} catch (Exception ex) {
